...
import { Layers, Code, CheckCircle, Video } from "lucide-react"
        ...
        <Card className="overflow-hidden bg-gray-800/50 backdrop-blur-sm border border-gray-700/30 hover:border-gray-700/50 transition-all duration-300">
            ...
            <CardContent className="pt-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* YouTube Video */}
                    {hasVideo && (
                        <div className="relative aspect-video rounded-lg overflow-hidden border border-gray-700/30 lg:col-span-1">
                            <iframe
                    ...
                    {hasImages && (
                        ...
                        >
                            {project.images.slice(0, 4).map((image, index) => (
                                <div
                                    key={index}
                                    className="relative aspect-video rounded-lg overflow-hidden border border-gray-700/30 hover:border-gray-700/50 transition-all group"
                                >
                                    <Image
                            ...
                            {project.images.length > 4 && (
                                <div className="relative aspect-video rounded-lg overflow-hidden border border-gray-700/30 hover:border-gray-700/50 transition-all group">
                                    <Image
